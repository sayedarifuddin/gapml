...
def main():
  st.markdown("<h4 style='text-align: center; color: Black;background-color:#0068ff'>US Graduate Admission Predictor</h4>", unsafe_allow_html=True)
  ...
  st.markdown('#')
  st.markdown("<h4 style='text-align: center; color: White;background-color:#006a4e'>Developed by 181006912 & 181008412</h4>", unsafe_allow_html=True)
